...
void FVCEditorTimeOfDay::OnModuleStartup()
{
	...
	UToolMenus::RegisterStartupCallback(FSimpleMulticastDelegate::FDelegate::CreateRaw(this, &FVCEditorTimeOfDay::RegisterMenus));

	TickDelegate = FTSTicker::GetCoreTicker().AddTicker(FTickerDelegate::CreateRaw(this, &FVCEditorTimeOfDay::Tick));
}

void FVCEditorTimeOfDay::OnModuleShutdown()
{
	FTSTicker::GetCoreTicker().RemoveTicker(TickDelegate);
}

void FVCEditorTimeOfDay::RegisterMenus()
{
...
bool FVCEditorTimeOfDay::Tick(float DeltaTime)
{
